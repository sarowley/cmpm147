...
function setup() {
  ...
  let input = createInput("Crossword");
  input.parent(label);
  input.input(() => {
    rebuildWorld(input.value());
  });

  createP("Arrow keys scroll. Clicking begins to fill in a word in the crossword one letter at a time. Words only generate bottom left to top right.").parent("container");
