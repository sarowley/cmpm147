...
function setup() {
  ...
  let input = createInput("Eyeballs");
  input.parent(label);
  input.input(() => {
    rebuildWorld(input.value());
  });

  createP("Arrow keys scroll. Click to toggle 'disco mode'. (PS. The eyes are focused around the center point of the rectangle)").parent("container");
